...
if __name__ == "__main__":
    mrbt = MRVectorBacktester('GDX', '2010-1-1', '2016-12-31', 10000, 0.0)
    print(mrbt.run_strategy(SMA=25, threshold=5))
    mrbt = MRVectorBacktester('GDX', '2010-1-1', '2016-12-31', 10000, 0.001)
    print(mrbt.run_strategy(SMA=25, threshold=5))
    mrbt = MRVectorBacktester('GDX', '2010-1-1', '2016-12-31', 10000, 0.001)
    print(mrbt.run_strategy(SMA=25, threshold=7.5))
